...
<html>
	<head>
		<title>la taille de votre bite est-elle correct?</title>
	</head>
	<body>
		<!--table displaying CWT logo and page title -->
		<table width="80%" align="center">
			<tr>
				<td><img src="penis.png" width="200" height="174" align="right" style="WIDTH: 200px; HEIGHT: 174px"></td>
				<td><big><b>&nbsp;&nbsp;Votre Bite<3 </big></B></td>
			</tr>
		</table>
		...
		<form name="frmOrderItem" action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post">
			<p><table width="80%" border="5" cellspacing="3" cellpadding="5" align="center">
					...
					<tr>
						...
						<td align="center">longue,petite,grosse,fine</td>
						<td align="center">noire,blanche,baige,jaune</td>
                        <td align="center">circoncis?</td>
                        <td align="center"><input type="hidden" name="couverture?" value="259.99">100</input></td>
						<td align="center">Yes, et tu vas kiffer!!!</td>
					</tr>
				</table>
			</p>
			<p>
				...
				<table width="80%" cellspacing="3" cellpadding="5" align="center">
					<tr>
						<td width="70%"><big>indique la taille que tu veux</big> <input type="text" name="txtQuantity" size="10"></td>
                        <td width="70%"><big>indique combien de bite tu veux</big> <input type="text" name="txtQuantity" size="10"></td>
                        <td width="70%"><big>pour en faire quoi?</big> <input type="text" name="txtQuantity" size="10"></td>
