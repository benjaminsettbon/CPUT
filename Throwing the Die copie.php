...
<pre>
      <td> How many times do you want to throw the die?<input type="text" name="valeur" size="10"></td>
...
<?php
    ...
    $valeur = $_POST['valeur'];
    //$probabilite = $_POST['num de la face'];

    for ($lance = 1; $lance <= $valeur; $lance++) {// on demande de tirer 2000 fois
